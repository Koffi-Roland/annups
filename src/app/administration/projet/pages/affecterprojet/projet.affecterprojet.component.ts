...
@Component({
    selector: 'app-home-admin-affecter-projet',
    templateUrl: './projet.affecterprojet.component.html',
    styleUrls: ['./projet.affecterprojet.component.css'],
    providers: [{ provide: NgbDateParserFormatter, useClass: NgbDateFRParserFormatter }]
})
export class AffectationProjetComponent implements OnInit {
    ...
    onSubmit() {
        if (this.form.valid) {
            ...
            try {
                ...
                this.projetService.affecterChefProjet(this.singleSelect[0].id,this.entity.id).subscribe( response=> {
