...
import { ChangerChefProjetComponent } from './projet.changerchefprojet.component';
...
export const PROJET_CHANGECHEF_UPDATE_ROUTES: Routes = [
    { path: 'projetchangerchef/:id',
        component: ChangerChefProjetComponent,
